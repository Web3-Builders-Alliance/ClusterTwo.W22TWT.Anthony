use cosmwasm_std::{DepsMut, Env, MessageInfo, Response, SubMsg, WasmMsg, to_binary, ReplyOn};

use crate::{ContractError, state::{CONFIG, next_id}, msg::InitPoolMsg};
...
// to be done in the reply
    // POOLS.save(deps.storage, id, &prop)?;
